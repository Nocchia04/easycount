...
import NavbarMobile from './mobile-dashboard-elements/navbar-mobile/navbar-mobile'
import DashboardMobile from './mobile-dashboard-elements/dashboard-mobile'
...
function Dashboard() {
  ...
  const [chooseMobile, setChooseMobile] = useState("generale")
  ...
  return (
    <div className='dashboard-container'>
      ...
      <div className='content-section-mobile'>
        <NavbarMobile setChooseMobile={handleMenuChange}/>
        <DashboardMobile chooseMobile={chooseMobile}/>
      </div>
    </div>
  )
}
